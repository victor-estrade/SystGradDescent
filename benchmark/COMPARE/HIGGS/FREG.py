...
# Command line
# python -m benchmark.COMPARE.HIGGS.FREG
...
def main():
    ...
    # make_hp_table(data_name, benchmark_name, FREG_HP, FREGLoader)
    # make_common_plots(data_name, benchmark_name, FREG_HP, FREGLoader)
